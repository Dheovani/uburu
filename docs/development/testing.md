...
Product validation against representative real-world datasets is defined in [validation.md](validation.md). It complements this automated test architecture and must not replace deterministic regression tests for bugs discovered during manual validation.
