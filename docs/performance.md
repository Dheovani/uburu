...
The benchmark suite contains matching many-small-file and few-large-file scenarios for automatic worker selection and fixed counts of 1, 2, 4, and 8 workers. This makes throughput scaling and queueing effects measurable without replacing correctness tests. Further tuning must use reproducible before/after results rather than increasing concurrency blindly.
