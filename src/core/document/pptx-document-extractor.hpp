...
namespace uburu::document
{
  ...
  class PptxDocumentExtractor final : public DocumentExtractor
  {
  public:
    /**
    ...
    /**
     * Checks whether the file extension is supported by the PPTX extractor.
     */
    [[nodiscard]]
    bool supports(const std::filesystem::path& path) const override;

    /**
     * Streams slide and speaker-note text without extracting the whole package.
     */
    [[nodiscard]]
